...
class SD21PipelineWrapper:
    ...
    def load(self):
        ...
        try:
            ...
            raise RuntimeError(
                "Failed to construct the intended SD2.1 DDIM scheduler"
            ) from exc
    ...
    def get_initial_latents(self, seed: int = 42) -> torch.Tensor:
        ...
        # Match the standard Diffusers reproducibility path: seed on CPU,
        # then move prepared latents to CUDA. This keeps the UGILE base path
        # comparable with wrapper.generate()/official pipeline runs.
