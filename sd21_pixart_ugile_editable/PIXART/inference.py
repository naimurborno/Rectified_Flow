...
def resolve_args(args, cfg: dict) -> dict:
    ...
    return {
        ...
        "num_steps":       cfg.get("flow", {}).get("num_steps", 20),
        "guidance_scale":  cfg.get("flow", {}).get("guidance_scale", 4.5),
...
def main():
    ...
    if model_name in ("sd3_onlb", "sd3_peakback", "sd3_ugile", "sana_ugile", "lumina2_ugile", "pixart_sigma_ugile"):
        seeds = opts["seeds"]
